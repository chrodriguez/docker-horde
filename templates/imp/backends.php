...
$servers['myserver'] = array(
  'disabled' => false,
  'name' => 'IMAP Server',
  'hostspec' => $_ENV['IMP_HOSTSPEC'],
  'maildomain' => $_ENV['IMP_MAILDOMAIN'],
  'hordeauth' => strcasecmp(isset($_ENV['IMP_HORDEAUTH'])?$_ENV['IMP_HORDEAUTH']:'true','true') == 0,
  'protocol' => isset($_ENV['IMP_PROTOCOL'])? $_ENV['IMP_PROTOCOL']:'imap/notls',
  'port' => isset($_ENV['IMP_PORT'])? $_ENV['IMP_PORT']:143,
  'secure' => strcasecmp(isset($_ENV['IMP_SECURE'])?$_ENV['IMP_SECURE']:'true','true') == 0,
  'quota' => array(
    'driver' => 'imap',
    'params' => array(),
  )
